...
interface AdminLayoutProps {
  children?: React.ReactNode; // Cho phép truyền children khi không dùng Outlet
}
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-6">
          {/* Nếu dùng React Router => Outlet chạy */}
          <Outlet />

          {/* Nếu import AdminLayout như wrapper => children chạy */}
          {children}
        </main>
      </div>
    </div>
